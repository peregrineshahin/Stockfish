...
void MovePicker::score() {
  ...
  [[maybe_unused]] Bitboard threatenedByPawn, threatenedByMinor, threatenedByRook, threatenedByQueen, threatenedPieces, unDefendedPiece;
  if constexpr (Type == QUIETS)
  {
      ...
      unDefendedPiece  = ~pos.attacks_by<PAWN>(us)   & ~pos.attacks_by<KNIGHT>(us)
  ...
  for (auto& m : *this)
      ...
      else if constexpr (Type == QUIETS)
      {
          ...
          m.value -= !(threatenedPieces & from) ?
                        (pt == QUEEN ?  (bool(to & threatenedByQueen & unDefendedPiece)) * 100000
